<template>
  <div class="flex flex-wrap mb-4 select-none">
    ...
    <button class="bg-primary-500 hover:bg-primary-700 text-white font-bold py-1 px-2 rounded bg-primary cursor-pointer shadow-md max-w-full mr-4"
            type="button"
            @click="bulkAll"
    ...
    <template v-if="$parent.bulkLen()">
      ...
      <button class="bg-primary-500 hover:bg-primary-700 text-white font-bold py-1 px-2 rounded bg-success cursor-pointer shadow-md max-w-full mr-4"
    ...
    <label class="bg-primary-500 hover:bg-primary-700 text-white font-bold py-1 px-2 rounded bg-90 text-center cursor-pointer shadow-md max-w-full ml-auto">
      <input
        id="nml_upload"
